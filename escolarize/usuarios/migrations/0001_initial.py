    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('password', models.CharField(default='senha123', max_length=128)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_nascimento', models.DateField()),
                ('password', models.CharField(default='senha123', max_length=128)),
                ('serie', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='alunos', to='notas.serie')),
                ('usuario', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
